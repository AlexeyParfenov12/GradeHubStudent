...
<h2 class="groupe" style="font-size: 20px; margin-top:50px">Задания группы</h2>
<div class="positionListGroup">
  <ol class="lessonList">
    <?php echo fnAddLessonsGroupItems($group_id, $course_id, $student_id); ?>
  </ol>
</div>
    ...
    <ol class="lessonList">
        <li class="dropdown">
            <a style="text-decoration:none; color:#0056b3" href="javascript:void(0)">
                <div class="liLessons">
                    <p style="grid-column: 1;margin-left: 3%; align-items:center;">Добавьте задание в группу</p>
                    <img height="25px" style="grid-column: 2;" src="../assets/img/arrow-angle-down-circle.svg">
                </div>
            </a>
            <div class="dropdown-content">
                <ol class="lessonListItems">
                    <?php echo fnAddLessonsGroup($course_id, $group_id); ?>
                </ol>
            </div>
        </li>
    </ol>
